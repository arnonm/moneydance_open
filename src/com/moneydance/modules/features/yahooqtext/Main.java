  ...
  implements ResourceProvider
{
  ...
  static final String SUPPORT_TLV = "yahootqt.supportTLV";
  ...
  public boolean getBool(final String key) {
    ...
    return Boolean.parseBoolean(_resources.getString(key));
  }
  ...
  static Image getIcon() {
    try {
      ...
      java.io.InputStream in =
          cl.getResourceAsStream("/com/moneydance/modules/features/yahooqtext/icon-yahooqt.gif");
      if (in != null) {
